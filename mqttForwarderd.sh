...
### BEGIN INIT INFO
# Provides:          MqttForwarderDeamon
# Required-Start:    $remote_fs $named $syslog
# Required-Stop:     $remote_fs $named $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: DEBIAN initscript for node.js Mqtt forwader app
# Description:       This node js driven service is used for forwarding mqtt things data to their AWS shadow instances
...
DAEMON_ARGS="/home/ubuntu/2_GIT/MqttForwarder/mqttForwarder.js"               # path to your node.js server/app
...
#	to add to startup do: sudo update-rc.d mqttForwarderd.sh defaults		   #
#   to remove: sudo update-rc.d -f mqttForwarderd.sh						   #
#   to enable: sudo update-rc.d mqttForwarderd.sh enable					   #
#   to disable: sudo update-rc.d mqttForwarderd.sh disable					   #
#   to start:  sudo service mqttForwarderd.sh start         				   #	
#	to stop:   sudo service mqttForwarderd.sh stop       					   #
# ------------------------------------------------------------------------------ 
